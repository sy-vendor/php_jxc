...
if( !isset($cfg_ver_lang) ){
	if(preg_match('/utf/i',$cfg_version)) $cfg_ver_lang = 'utf-8';
...
function ShowMsg($msg,$gourl,$onlymsg=0,$limittime=0)
{
	  ...
	  if( preg_match("/^gb/i",$cfg_ver_lang) ) $cfg_ver_lang = 'utf8';
		$htmlhead  = "<html>\r\n<head>\r\n<title>WEB ERP SYSTEM NOTICE</title>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset={$cfg_ver_lang}\" />\r\n";
      ...
      function JumpUrl(){
        if(pgo==0){ location='$gourl'; pgo=1; }
			...
			$rmsg = $func;
			$rmsg .= "document.write(\"<br/><div style='width:400px;padding-top:4px;height:24;font-size:10pt;border-left:1px solid #547ac7;border-top:1px solid #547ac7;border-right:1px solid #547ac7;background-color:#668cd8;'>WEB ERP SYSTEM NOTICE：</div>\");\r\n";
...
function filterscript($str) {
	$str = preg_replace("/iframe/i","ｉｆｒａｍｅ",$str);
